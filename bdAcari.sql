...
create table despesas(id_despesa serial primary key,titulo varchar(60),id_tipo int,valor unsigned int,foreign key id_tipo references tipos_despesas(id_tipo));
